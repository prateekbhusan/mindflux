        ...
        switch (actionType) {
            ...
            case "update": {
                ...
                return data({
                    ...
                    memories: fakeMemories.map(m => m.id === Number(memoryId)
                        ? { ...m, content }
                        : m),
                });
            }
...
export default function Home({ loaderData }) {
    return (_jsx(Welcome, { message: loaderData.message, userId: loaderData.userId, initialMemories: loaderData.memories }));
}
