...
export function Welcome({ message, userId, initialMemories, }) {
    ...
    return (<main className="min-h-screen bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 relative overflow-hidden">
            ...
            <header className="relative w-full px-6 py-6 flex justify-between items-center backdrop-blur-sm border-b border-white/5">
                ...
                <div className="flex gap-8 text-sm">
                    <a href="https://x.com/dhravyashah" className="text-white/60 hover:text-white/90 transition-colors duration-300 hover:scale-105 transform">
                        X
                    </a>
                    <a href="mailto:dhravya@mindflux.com" className="text-white/60 hover:text-white/90 transition-colors duration-300 hover:scale-105 transform">
                        Contact us
                    </a>
                </div>
            </header>
            ...
            <div className="relative w-full max-w-7xl mx-auto px-6 md:px-8 mt-12">
                <div className="text-center mb-20">
                        ...
                        <div className="relative">
                            ...
                            <div className="relative bg-gradient-to-r from-blue-500/10 to-cyan-500/10 backdrop-blur-sm border border-white/10 rounded-xl px-6 py-3">
                                <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-cyan-300 to-blue-400 font-medium">
                                    Powered by the{" "}
                                    <a href="https://docs.mindflux.ai" className="font-bold underline decoration-blue-400/50 hover:decoration-blue-400 transition-colors">
                                        mindflux API
                                    </a>
                                </span>
                            </div>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mb-8">
                        <a href="https://mindflux.ai" className="group relative bg-gradient-to-r from-blue-600/20 to-cyan-600/20 hover:from-blue-600/30 hover:to-cyan-600/30 border border-blue-500/30 hover:border-blue-500/50 transition-all duration-300 px-6 py-3 rounded-xl font-medium text-white/90 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-blue-400 group-hover:scale-110 transition-transform">
                        ...
                        <a href="https://docs.mindflux.ai" className="group relative bg-gradient-to-r from-purple-600/20 to-blue-600/20 hover:from-purple-600/30 hover:to-blue-600/30 border border-purple-500/30 hover:border-purple-500/50 transition-all duration-300 px-6 py-3 rounded-xl font-medium text-white/90 flex items-center gap-2">
                            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-purple-400 group-hover:scale-110 transition-transform">
                    ...
                    <p className="text-lg text-white/60 mx-auto max-w-3xl leading-relaxed mb-8">
                        ...
                        <a href="https://docs.mindflux.ai" className="text-blue-400 hover:text-blue-300 font-medium underline decoration-blue-400/50 hover:decoration-blue-400 transition-colors mx-1">
                            mindflux API
                        </a>
                            ...
                            <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-white/10 p-8 hover:border-white/20 transition-all duration-300">
                                ...
                                <div className="space-y-8">
                                    <div className="flex gap-2">
                                        ...
                                        <button type="button" className="p-4 bg-blue-600/20 hover:bg-blue-600/30 border border-blue-500/30 hover:border-blue-500/50 transition-all duration-300 flex items-center justify-center rounded-xl group" onClick={() => {
                                        ...
                                        <div className="space-y-4">
                                            <div>
                                                ...
                                                <div className="flex flex-wrap gap-2">
                                                    {clients.map((client) => (<button key={client} type="button" onClick={() => setSelectedClient(client)} className={`px-4 py-2 text-sm font-medium transition-all duration-300 rounded-lg border ${selectedClient === client
                                    ...
                                    <div className="flex flex-col gap-4 pt-4">
                                        ...
                                        <div className="mt-6">
                                            ...
                                            <div className="flex flex-col gap-3">
                                                <input type="text" placeholder="Paste MCP URL here" className="w-full bg-slate-950/80 border border-white/10 focus:border-blue-500/50 rounded-xl p-4 font-mono text-sm text-blue-300 placeholder-white/40 focus:outline-none transition-all duration-300" onChange={(e) => setRestoreUrl(e.target.value)} value={restoreUrl}/>
                    ...
                    <div className="flex flex-col">
                        <div className="relative group h-full">
                            ...
                            <div className="relative bg-slate-900/80 backdrop-blur-xl rounded-2xl border border-white/10 h-full hover:border-white/20 transition-all duration-300">
                                ...
                                {memories.length > 0 ? (<ul className="max-h-[500px] overflow-y-auto">
                                        {memories.map((memory, index) => (<li key={memory.id} className="px-6 py-4 hover:bg-slate-800/30 transition-all duration-300 border-b border-white/5 last:border-b-0 group/item" style={{
                    animationDelay: `${index * 50}ms`,
                    animation: 'fadeInUp 0.5s ease-out forwards'
                }}>
                                                <div className="flex flex-col gap-2">
                                                    {isEditing === memory.id ? (<div className="flex items-center gap-2">
                                                            <input type="text" value={editedTitle} onChange={(e) => setEditedTitle(e.target.value)} className="w-full bg-slate-950/80 border border-blue-500/50 rounded-lg px-3 py-2 text-sm text-white/90 focus:outline-none focus:border-blue-500" autoFocus/>
                                                            <button type="button" onClick={() => updateMemory(memory.id)} className="p-2 bg-green-600/20 hover:bg-green-600/30 border border-green-500/30 rounded-lg text-green-400 transition-all duration-300" title="Save changes">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                                    <path d="M20 6L9 17l-5-5"/>
                                                                </svg>
                                                            </button>
                                                            <button type="button" onClick={cancelEditing} className="p-2 bg-red-600/20 hover:bg-red-600/30 border border-red-500/30 rounded-lg text-red-400 transition-all duration-300" title="Cancel editing">
                                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                                    <line x1="18" y1="6" x2="6" y2="18"/>
                                                                    <line x1="6" y1="6" x2="18" y2="18"/>
                                                                </svg>
                                                            </button>
                                                        </div>) : (<p className="text-white/80 break-words text-sm leading-relaxed">
                                                            {memory.summary}
                                                        </p>)}
                                                    <div className="flex justify-between items-center">
                                                        ...
                                                        <div className="opacity-0 group-hover/item:opacity-100 transition-all duration-300 flex gap-1">
                                                            {!isEditing && (<button type="button" onClick={() => startEditing(memory)} className="p-2 hover:bg-blue-600/20 border border-transparent hover:border-blue-500/30 rounded-lg text-white/60 hover:text-blue-400 transition-all duration-300" title="Edit memory">
                                                                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                                                        <path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/>
                                                                        <path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/>
                                                                    </svg>
                                                                </button>)}
                                                            {!isEditing && (<button type="button" onClick={() => deleteMemory(memory.id)} disabled={isDeleting === memory.id} className="p-2 hover:bg-red-600/20 border border-transparent hover:border-red-500/30 rounded-lg text-white/60 hover:text-red-400 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed" title="Delete memory">
                                                                    {isDeleting === memory.id ? (<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="animate-spin">
                                                                            <path d="M21 12a9 9 0 1 1-6.219-8.56"/>
                                    ...
                                    </ul>) : (<div className="py-20 text-center flex flex-col items-center">
